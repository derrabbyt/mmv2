...
- **`backend/conf/settings.py`**: Main Settings class
- **`backend/conf/db.py`**: Database settings
- **`backend/settings.py`**: Global settings instance
...
```python
from backend.conf.cache import CacheSettings
