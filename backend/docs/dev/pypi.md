...
ls dist/
# backend-1.2.3.tar.gz
# backend-1.2.3-py3-none-any.whl
```
...
1. Go to your project page: `https://pypi.org/project/backend/`
...
```bash
# View on PyPI
open https://pypi.org/project/backend/
